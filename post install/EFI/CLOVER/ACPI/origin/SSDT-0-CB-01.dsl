 ...
 *
 * Disassembly of SSDT-0-CB-01.aml, Sun Jan  6 16:53:05 2019
 *
        ...
        Device (TPM)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                If (LNotEqual (PTTB, 0xFED40040))
                {
                    ...
                    CreateDWordField (CRS0, \_SB.TPM._CRS._Y3A._BAS, CBAS)  // _BAS: Base Address
                    Store (PTTB, CBAS)
                    Return (CRS0)
                }
                Else
            ...
            OperationRegion (TNVS, SystemMemory, 0x3AF6D000, 0x26)
